...
- `definitions.yaml`: This YAML file contains all the definitions, parameters, and paths needed to run the drought clusters code. The user will need edit this file, at least to add the paths where the drought metric data is saved and where the drought cluster files will be saved.
