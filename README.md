...
6. Save the drought clusters for the current time step. Three files will be saved:
	...
	- `cluster-dictionary_' + str(current_date) + '.pck`: A pickled file with the dictionary for the current time step containing all the characteristics of the 2D drought clusters identified.
...
- Herrera-Estrada, J. E. and Diffenbaugh, N. S. (2020). Landfalling Droughts: Global tracking of moisture deficits from the oceans onto land. *Water Resources Research*, **56**, e2019WR026877. https://doi.org/10.1029/2019WR026877
